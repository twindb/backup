...
.. code-block:: console
    ...
    # Download the package
    wget https://twindb-release.s3.amazonaws.com/twindb-backup/3.6.1/focal/twindb-backup_3.6.1-1_amd64.deb
    # Install TwinDB Backup
    apt install ./twindb-backup_3.6.1-1_amd64.deb
...
.. code-block:: console
    ...
    $ ls omnibus/pkg/*.deb
    omnibus/pkg/twindb-backup_3.6.1-1_amd64.deb
