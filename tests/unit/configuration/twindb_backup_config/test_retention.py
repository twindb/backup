...
def test_retention(config_file):
    ...
    assert tbc.retention == RetentionPolicy(hourly=24, daily=7, weekly=4, monthly=12, yearly=3)

    assert tbc.retention_local == RetentionPolicy(hourly=24, daily=7, weekly=4, monthly=12, yearly=3)
