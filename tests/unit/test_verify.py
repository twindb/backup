...
@mock.patch('twindb_backup.verify.tempfile')
...
def test_verify_mysql_backup_if_restore_is_success(mock_get_dst, mock_restore,
                                                   mock_edit, mock_verify):
    ...
    mock_verify.mkdtemp.return_value = "/dst/path"
...
@mock.patch('twindb_backup.verify.restore_from_mysql')
@mock.patch('twindb_backup.verify.get_destination')
def test_verify_mysql_backup_if_restore_is_failed(mock_get_dst, mock_restore,
                                                  mock_edit, mock_verify):
    mock_config = mock.Mock()
    mock_config.get.return_value = "/foo/bar"
    mock_dst = mock.MagicMock()
    ...
    mock_dst.get_latest_backup.return_value = "/foo/bar"
    mock_get_dst.return_value = mock_dst
    mock_verify.mkdtemp.return_value = "/foo/bar/"
